...
public class UserMainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_duyurular2) {
            startAnnouncementsActivity();
        } else if (id == R.id.nav_calisanlar2) {
            startUsersListActivity();
        } else if (id == R.id.nav_kisiseld2) {
            startPersonalAnnouncementsActivity();
        } else if (id == R.id.nav_ayarlar2) {
            openSettingsDialog();
        } else if (id == R.id.nav_cikis2) {
            logOutAccount();
        }
    ...
    private void startPersonalAnnouncementsActivity() {
        Intent intent = new Intent(UserMainActivity.this, PersonalAnnouncementsActivity.class);
        intent.putExtra("id", kisi.getId().toString());
        startActivity(intent);
    }

    private void startAnnouncementsActivity() {
        Intent intent = new Intent(UserMainActivity.this, AnnouncementsActivity.class);
        intent.putExtra("RootClass", "UserMainActivity.java");
        startActivity(intent);
    }

    private void startUsersListActivity() {
        Intent intent = new Intent(UserMainActivity.this, UsersListActivity.class);
        intent.putExtra("RootClass", "UserMainActivity.java");
        startActivity(intent);
    }
